...
def login_user(request):
    if request.method == "POST":
        ...
        if result['success']:
            ...
            return render(request, 'music/login.html', {'error_message': 'Invalid reCAPTCHA. Please try again.'})
...
def register(request):
    ...
    if form.is_valid():
        ...
        message = 'hey '+ username +', your account has been registered successfully.'
